...
namespace TTMS_OOP.Forms
{
    public partial class PrintPreviewForm : Form
    {
        ...
        private void DrawTimetableClassic(Graphics g, int sx, int sy, Section sec)
        {
            ...
            Font creditFont = new Font("Segoe UI", 8f, FontStyle.Regular);
            g.DrawString("Generated by TTMS  ·  By Shahzaib (1258)", creditFont, new SolidBrush(Color.FromArgb(150, 160, 180)), sx, totalH+26);
        }
        ...
        private void DrawTimetableExecutive(Graphics g, int sx, int sy, Section sec)
        {
            ...
            // Bottom Left Attribution in place of printed line (subtle, clean footer)
            Font execCreditFont = new Font("Segoe UI", 8f, FontStyle.Regular);
            g.DrawString("Generated by TTMS  ·  By Shahzaib (1258)", execCreditFont, new SolidBrush(Color.FromArgb(150, 160, 175)), sx, sigY + 8);
        }
